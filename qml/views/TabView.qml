...
TabBar {
    ...
    TabButton {
        ...
        contentItem: RowLayout {
            ...
            Rectangle {
                ...
                visible: characterModel && characterModel.totalStatPoints !== undefined && characterModel.totalStatPoints > 0
                ...
                function getStatsIndicatorColor() {
                    ...
                    if (total === 72)
                        return "#4CAF50";      // Standard Array
                    if (total >= 65 && total <= 80)
                        return "#FFC107";  // Good range
    ...
    TabButton {
        ...
        contentItem: RowLayout {
            ...
            Rectangle {
                ...
                visible: characterModel && characterModel.biography !== undefined && characterModel.biography.length > 0
                ...
                function getBiographyIndicatorColor() {
                    ...
                    if (length >= 500)
                        return "#4CAF50";     // Good detail
                    if (length >= 100)
                        return "#FFC107";     // Some detail
    ...
    TabButton {
        ...
        contentItem: RowLayout {
            ...
            Rectangle {
                ...
                radius: 6
                color: "#4CAF50"
                visible: characterModel && characterModel.relationshipCount !== undefined && characterModel.relationshipCount > 0
        ...
        contentItem: RowLayout {
            ...
            RowLayout {
                ...
                Rectangle {
                    ...
                    radius: 6
                    color: "#FF9800"
                    visible: characterModel && characterModel.eventCount !== undefined && characterModel.eventCount > 0
                ...
                Text {
                    text: "⭐"
                    font.pixelSize: 8
                    visible: characterModel && characterModel.majorEventCount !== undefined && characterModel.majorEventCount > 0
                    opacity: 0.8
                }
            }
        }
    ...
    readonly property var tabNames: ["overview", "enneagram", "statistics", "biography", "relationships", "timeline"]
